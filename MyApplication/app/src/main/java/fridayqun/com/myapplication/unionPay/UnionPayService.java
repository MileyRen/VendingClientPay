...
import static fridayqun.com.myapplication.unionPay.UnionPayConfig.termId;
...
public class UnionPayService {
    ...
    public static String getUnionPayRes(String orderId, String txnAmt, String txnTime,String payTimeout) {
        String result = null;
        Map<String, String> contentData = new HashMap<String, String>();
        /***商户接入参数***/
        contentData.put("merId", merId);            //商户号码，请改成自己申请的商户号或者open上注册得来的777商户号测试
        contentData.put("termId", termId);           //终端号，可不设置
        contentData.put("payTimeout",payTimeout);    //设置支付超时时间，超出此事件用户支付成功的交易，不通知商户，系统自动退款，约5个工作日返还
